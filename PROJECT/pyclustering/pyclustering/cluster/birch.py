...
class birch:
    ...
    def __init__(self, data, number_clusters, hadoop_address , branching_factor = 5, max_node_entries = 5, initial_diameter = 0.005, type_measurement = measurement_type.CENTROID_EUCLIDIAN_DISTANCE, entry_size_limit = 200, ccore = False):
        """!
