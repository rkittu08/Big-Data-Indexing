...
class cfentry:
    ...
    @property
    def hadp_address(self):
        """!
        
        @return (string) Hadoop address.
        
        """
        return self.__h_address;
    
    
    def __init__(self, number_points, linear_sum, square_sum,hadoop_address):
        """!
        ...
        @param[in] hadoop_address (string): Holds the hadoop address for a record
        """
        self.__number_points = number_points;
        self.__linear_sum = linear_sum;
        self.__square_sum = square_sum;
        hadoop_address.sort();
        self.__h_address = hadoop_address;
    ...
    def __copy__(self):
        ...
        """
        return cfentry(self.__number_points, self.__linear_sum, self.__square_sum,self.__h_address);
    ...
    def __repr__(self):
        ...
        """
        return 'CF (%s, %s, %0.2f) [%s] Hadoop_adress %s' % ( self.number_points, self.linear_sum, self.__square_sum, hex(id(self)),self.__h_address );    
    ...
    def __add__(self, entry):
        ...
        hadp_address = list(set(self.hadp_address+ entry.hadp_address));
        hadp_address.sort();
        return cfentry(number_points, linear_sum, square_sum, hadp_address);
    ...
    def __sub__(self, entry):
        ...
        return cfentry(number_points, linear_sum, square_sum,self.hadp_address);        
